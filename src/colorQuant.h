...
class Bucket{
	...
	public:
        ...
        /**
         *  @funct: checks whether 2/3 dim are equivalent and other dim is aligned
         *  @param: Bucket& otherBucket - other bucket to compare with
         *  @return: bool - true if successful match
         **/
        bool matches(Bucket &otherBucket);
        ...
        /**
         *  @funct: sets internal mean quantized color of bucket
         *  @note: for efficiency improvements, call after palette|bucket has
         *  been built and finalized
         **/
        void setColor();
};
